...
# Scrapy settings for tcs project
#
...
SPIDER_MODULES = ['tcs.spiders']
NEWSPIDER_MODULE = 'tcs.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'tcs (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'tcs.middlewares.TcsSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See http://scrapy.readthedocs.org/en/latest/topics/downloader-middleware.html
#DOWNLOADER_MIDDLEWARES = {
#    'tcs.middlewares.MyCustomDownloaderMiddleware': 543,
#}
...
ITEM_PIPELINES = {
   'tcs.pipelines.CnblogMysqlPipeline': 1,
}
